...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var myTasksLabel: UILabel!
    ...
    override func viewDidLoad() {
        ...
        myTasksLabel.font = UIFont(name:"PoiretOne-Regular",size:30)
...
extension ViewController : UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let hucre = tableView.dequeueReusableCell(withIdentifier: "toDoTableCell", for: indexPath) as! ToDotableViewCell
        hucre.durumView.layer.cornerRadius = hucre.durumView.frame.width / 2
...
//        }
        ...
        hucre.yapilacakIsListesi.font = UIFont(name:"PoiretOne-Regular",size:22)
